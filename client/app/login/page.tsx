...
import { Container, Input, Button, Spinner } from "@/components/ui";
    ...
    <div className="relative min-h-[100svh] -mt-[88px] overflow-hidden flex items-center justify-center px-4 pt-32 pb-20 sm:px-6">
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-rise">
        <div className="text-center mb-10">
          ...
          >
            Step <em className="not-italic text-muted-foreground">back into</em>{" "}
            the silence.
          </h1>
        </div>
        ...
        <div className="liquid-glass-strong rounded-3xl p-5 sm:p-8">
          ...
          <form onSubmit={onSubmit} className="flex flex-col gap-5">
            ...
            <Input
              ...
              leading={<Icon.Lock className="w-4 h-4" />}
            />
    ...
    <>
      <div
        ...
        style={{
          ...
          height: 480,
          background:
            "radial-gradient(circle, hsl(220 80% 50% / 0.4), transparent 60%)",
          top: "-10%",
          left: "-10%",
        }}
      />
      <div
        ...
        style={{
          ...
          height: 420,
          background:
            "radial-gradient(circle, hsl(280 70% 60% / 0.3), transparent 60%)",
          bottom: "-15%",
          right: "-5%",
          animationDelay: "3s",
        }}
